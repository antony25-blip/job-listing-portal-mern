    ...
    <DashboardLayout>
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <Card className="animate-slide-up overflow-hidden">
          <div className="h-32 gradient-primary flex items-end px-6 pb-4">
            <div className="w-32 mr-4" /> {/* Spacer for avatar */}
            <div className="mb-1">
              <h2 className="text-3xl font-bold text-white mb-0.5" style={{ fontFamily: "var(--font-display)" }}>
                {name}
              </h2>
              <p className="text-white/90 font-medium">{title || "Add your job title"}</p>
            </div>
          </div>
          <CardContent className="relative pb-6">
            <div className="flex flex-col sm:flex-row sm:items-start gap-4 -mt-16">
              ...
              <div className="flex-1 mt-16 sm:mt-24">
                {/* Location and Contact Info in the white section */}
